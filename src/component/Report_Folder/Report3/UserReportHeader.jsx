...
const UserReportHeader = ({ title, reportId , language}) => {
  ...
  return (
    <div className="relative mb-10">
      ...
      {/* Back Button */}
      <div className={`fixed top-6 ${isRTL ? "right-6" : "left-6"} z-50`}>
        <button
          onClick={() => navigate(-1)}
      ...
      {/* Report ID */}
      {reportId && (
        <div className={`fixed top-6 ${isRTL ? "left-6" : "right-6"} px-4 py-2 text-white font-semibold`}>
          {reportId}
        </div>
      )}
