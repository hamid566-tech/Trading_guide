...
const Mortgage_Report_page = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const res = await fetch(`http://localhost:5000/api/mortgage?${query}`);
    ...
    <div className="mt-24 max-w-full px-4 sm:px-6 lg:px-8 select-none">
      <div className="bg-white/10 backdrop-blur-xl rounded-2xl text-white shadow-2xl border border-white/20 p-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-4">
          ...
          <button
          onClick={() => generateReportPDF(columns, filteredData, filters, t.mortgage_report, t, language)}
...
export default Mortgage_Report_page
